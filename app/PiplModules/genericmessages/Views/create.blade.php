...
@section("meta")
    <title>Create Generic Message</title>
@endsection
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/genericmessages/list')}}">Manage Generic Messages</a>
                    <i class="fa fa-table"></i>
                </li>
                <li>
                    <a href="javascript:void(0);">Create Generic Message</a>
                </li>
            </ul>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i> Create Generic Message
                    </div>
                </div>
                                        ...
                                        <div class="form-group @if ($errors->has('message')) has-error @endif">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @if ($errors->has('message'))
                                                    <span class="help-block"><strong class="text-danger">{{ $errors->first('message') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
