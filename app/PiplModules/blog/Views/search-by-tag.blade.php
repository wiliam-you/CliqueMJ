...
@section('meta')
<title>Search Results for "{{$tag->name}}" tag</title>
<style>
...
<h1>Search Results for <i>"{{$tag->name}}"</i> tag</h1>
<div class="row">
...
<div class="panel panel-default">
    ...
    @if(count($posts) < 1)
    <div class="well">We didn't found any post related to "{{$tag->name}}" tag. Please try other tags.</div>
    @endif
