...
<title>Update Get Started Section</title>
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="{{url('admin/get-started-section/list')}}">Manage How It Works Section</a>
                                        <i class="fa fa-circle"></i>
					
				</li>
				<li>
					<a href="javascript:void(0);">Update How It Works Section</a>
      ...
      <!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box blue">
             <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-gift"></i> Update A How It Works Section
                        </div>
