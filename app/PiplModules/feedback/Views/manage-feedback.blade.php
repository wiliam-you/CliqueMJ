				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-globe"></i>Manage Feedback
							</div>
							<div class="tools">
...
$(function() {
    $('#tbl_regusers').DataTable({
        ...
        serverSide: true,
        //bStateSave: true,
        ajax: {"url":'{{url("/admin/feedback-dispensary-list")}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
                ...
                render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        if(row.feedback_count>0)
                        	return row.name+' <span class="badge badge-error">'+row.feedback_count+'</span>';
                        else
                            return row.name;
                    }
                    return data;
            ...
            {data:   "Update",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a class="btn btn-sm btn-primary" href="{{url("admin/feedback/all/")}}/'+row.user_id+'">Manage Feedbacks</a>';
                    }
                    return data;
                },
                  "orderable": false,
