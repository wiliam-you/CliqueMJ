...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Manage {{$user->userInformation->dispensary_name}}'s Products</a>
						...
						<div class="portlet-title">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="{{url('/admin/product/create/'.$user->id)}}" id="sample_editable_1_new" class="btn green">
...
$(function() {
    $('#list_testimonial').DataTable({
        ...
        serverSide: true,
         //bStateSave: true,
        ajax: {"url":'{{url("/admin/product-data/".$user->id)}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
            ...
            {data:   "image",
                render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<img width="50px" src="{{url("/storage/app/public/product/")}}/'+row.image+'">';
                    }
                    return data;
                },
                "orderable": false,
