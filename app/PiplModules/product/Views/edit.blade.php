...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="{{url('admin/product/all/'.$product->user_id)}}">Manage Product</a>
          <i class="fa fa-circle"></i>
				</li>
				<li>
      ...
      <!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box blue">
             <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-gift"></i> Update A Product
                        </div>
                          ...
                          <label class="col-md-6 control-label">Photo</label>
                           <div class="col-md-6">     
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <img width="100px" src="{{url('/storage/app/public/product/'.$product->image)}}" alt="Product image">
                                </div>
