    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="javascript:void(0)">Manage Sub Users</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box grey-cascade">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="glyphicon glyphicon-globe"></i>Manage Sub Users
                            </div>
                            <div class="tools">
                            ...
                            {data:   "resend_link",
                                render: function ( data, type, row ) {
                                    ...
                                    if ( type === 'display' ) {
                                        ...
                                        return '<a class="btn btn-sm btn-default" href="{{url("admin/resent-verification-link/")}}/'+row.user_id+'">Resend Link</a>';
                                    }
                                    return data;
                                },
                                "orderable": false,
