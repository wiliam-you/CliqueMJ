...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Manage patient</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-globe"></i>Manage patient
							</div>
							<div class="tools">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="{{url('admin/create-patient')}}" id="sample_editable_1_new" class="btn green">
							...
							<tr>
                                ...
                                <th>Count Of Login</th>
                                                       ...
                                                       <input type="button" onclick='javascript:deleteAll("{{url('/admin/delete-selected-patient')}}")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">
						</div>
					</div>
...
$(function() {
    $('#tbl_regusers').DataTable({
        ...
        serverSide: true,
        //bStateSave: true,
        ajax: {"url":'{{url("/admin/list-registered-patient-data")}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
...
//            { data: 'user_name', name: 'user_name',searchable: true},
            ...
            { data: 'times_of_login', name: 'times_of_login',searchable: true},
            ...
            {data:   "Update",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a class="btn btn-sm btn-primary" href="{{url("admin/update-registered-patient/")}}/'+row.user_id+'">Update</a>';
                    }
                    return data;
                },
                  "orderable": false,
            ...
            {data:   "Delete",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<form id="delete_user_'+row.user_id+'" method="post" action="{{url("/admin/delete-patient")}}/'+row.user_id+'">{{ method_field("DELETE") }} {!! csrf_field() !!}<button onclick="confirmDelete('+row.user_id+')" class="btn btn-sm btn-danger" type="button">Delete</button></form>';
                    }
                    return data;
                },
                  "orderable": false,
