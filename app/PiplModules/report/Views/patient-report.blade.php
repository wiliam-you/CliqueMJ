...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Patient Reports</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i>Patient Reports
							</div>
							<div class="tools">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<label>Purchased By Patient: </label>
										<select class="form-control" id="patient" onchange="getData()">
...
$(function() {
    ...
    tbl_sale = $('#list_testimonial').DataTable({
        ...
        serverSide: true,
         //bStateSave: true,
        ajax: {"url":'{{url("/admin/patient-report-data")}}',"complete":afterRequestComplete, data: function(d){
