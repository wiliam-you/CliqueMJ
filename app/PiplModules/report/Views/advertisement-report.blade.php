...
@section("meta")
	...
	<title>Advertise Offer Reports</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Advertise Offer Reports</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i>Advertise Offer Reports
							</div>
							<div class="tools">
		...
		<script>
            ...
            $(function() {
                ...
                tbl_sale = $('#list_testimonial').DataTable({
                    ...
                    serverSide: true,
                    //bStateSave: true,
                    ajax: {"url":'{{url("/admin/advertisement-report-data")}}',"complete":afterRequestComplete, data: function(d){
