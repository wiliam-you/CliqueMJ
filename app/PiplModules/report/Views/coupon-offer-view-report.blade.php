...
@section("meta")
	...
	<title>Coupon And Offer View Reports</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Coupon And Offer View Reports</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i>Coupon And Offer View Reports
							</div>
							<div class="tools">
		...
		<script>
            ...
            $(function() {
                ...
                tbl_sale = $('#list_testimonial').DataTable({
                    ...
                    serverSide: true,
                    //bStateSave: true,
                    ajax: {"url":'{{url("/admin/coupon-offer-view-data")}}',"complete":afterRequestComplete, data: function(d){
                    ...
                    columns: [
                        ...
                        { data: 'advertisement_name', name: 'advertisement_name',searchable: true},
...
//                        { data: 'coupon_view', name: 'coupon_view',searchable: true},
                        { data: 'advertisement_mj_view', name: 'advertisement_mj_view',searchable: true},
                    ],
                });
            });
