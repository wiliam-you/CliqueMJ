    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{url('admin/zone/list')}}">Manage Cluster</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="javascript:void(0);">Edit Cluster</a>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i> Edit A Cluster
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-8">
                                        <div class="form-group @if ($errors->has('title')) has-error @endif">
                                            <label class="col-md-6 control-label">Title<sup>*</sup></label>
                                                <div class="col-md-6">
                                                <input name="title" type="text" class="form-control" id="title" value="{{old('title',$zone->title)}}">
                                                @if ($errors->has('title'))
                                  ...
                                  <strong class="text-danger">{{ $errors->first('title') }}</strong>
                                        ...
                                        <div class="form-group @if ($errors->has('limit')) has-error @endif">
                                            ...
                                            <div class="col-md-6">
                                                <input readonly name="limit" type="number" class="form-control" id="limit" value="{{old('limit',$zone->limit)}}">
                                                @if ($errors->has('limit'))
                                                    <span class="help-block">
