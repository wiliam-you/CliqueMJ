...
<title>Update Why Choose Us Section</title>
...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="{{url('admin/feature/list')}}">Manage Why Choose Us Section</a>
                                        <i class="fa fa-circle"></i>
					
				</li>
				<li>
					<a href="javascript:void(0);">Update Why Choose Us Section</a>
      ...
      <!-- BEGIN SAMPLE FORM PORTLET-->
        <div class="portlet box blue">
             <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-gift"></i> Update A Why Choose Us Section
                        </div>
